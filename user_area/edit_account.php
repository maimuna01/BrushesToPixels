<?php
  ...
  if(isset($_GET['edit_account']))
  {
    ...
    $select_query="SELECT * FROM  `user_buyer` where user_name='$user_session_name'" ;
...
<body>
  ...
  <form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="form-outline mb-4 d-flex   w-50 m-auto ">
      ...
      <img src="./user_images/<?php echo $user_image?>" alt="imag user " class="profile_image">
    </div>
    <div class="form-outline mb-4">
